...
class PoolStatus:
  ...
  def getEthPerDay(self):
    return self.getEthPerMin()*constants.MINUTES_PER_HOUR*constants.HOURS_PER_DAY
  ...
  def getUsdPerDay(self):
    return self.getUsdPerMin()*constants.MINUTES_PER_HOUR*constants.HOURS_PER_DAY
